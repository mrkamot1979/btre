...
class Listing(models.Model):
    ...
    photo_1 = models.ImageField(upload_to = 'photos/%Y/%m/%d/', blanke=True)
    photo_2 = models.ImageField(upload_to = 'photos/%Y/%m/%d/', blanke=True)
    photo_3 = models.ImageField(upload_to = 'photos/%Y/%m/%d/', blanke=True)
    photo_4 = models.ImageField(upload_to = 'photos/%Y/%m/%d/', blanke=True)
    photo_5 = models.ImageField(upload_to = 'photos/%Y/%m/%d/', blanke=True)
    photo_6 = models.ImageField(upload_to = 'photos/%Y/%m/%d/', blanke=True)
